# Generated by Django 5.0.14 on 2025-10-18 16:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Notification subject/title", max_length=200
                    ),
                ),
                (
                    "message",
                    models.TextField(help_text="Main notification message content"),
                ),
                (
                    "category",
                    models.CharField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="Send to all active customers"
                    ),
                ),
                (
                    "target_vip_only",
                    models.BooleanField(
                        default=False, help_text="Send only to VIP customers"
                    ),
                ),
                (
                    "target_min_points",
                ...
                (
                    "total_delivered",
                    models.IntegerField(
                        default=0, help_text="Successfully delivered count"
                    ),
                ),
                (
                    "total_read",
                ...
                (
                    "total_failed",
                    models.IntegerField(default=0, help_text="Failed delivery count"),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Internal notes about this notification"
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_customer", "-created_at"],
                name="notificatio_tenant__240c19_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="notificationrecipient",
            index=models.Index(
                ...
                name="notificatio_notific_e69ff3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="notificationrecipient",
            index=models.Index(
                fields=["is_read"], name="notificatio_is_read_3bd5c2_idx"
            ),
        ),
