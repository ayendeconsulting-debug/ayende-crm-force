...
FIXED: Removed conflicting /admin/ route that was hijacking Django admin
"""
...
urlpatterns = [
    ...
    # Dashboard - Business Command Center (accessible at root and /dashboard/)
    ...
    # ✅ REMOVED: path('admin/', views.main.dashboard_home, name='admin')
    # This was conflicting with Django admin and preventing proper routing
    # Business owners are now redirected to /reports/ by dashboard_home view
